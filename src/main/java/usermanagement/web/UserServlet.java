...
@WebServlet(name = "UserServlet", urlPatterns = {"/crud", "/users", "/"})
public class UserServlet extends HttpServlet {
    ...
    private void listUsers (HttpServletRequest request, HttpServletResponse response)
        ...
        for (User elem: listUser) {
            ...
            response.getWriter ().println (elem.getID () + " " + elem.getName () + " " + elem.getEmail () + " " + elem.getCountry ());
        }

        String convertListUser = listUser.stream ().map (User::toString).collect(Collectors.joining (","));
